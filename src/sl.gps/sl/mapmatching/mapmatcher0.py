...
if __name__ == '__main__':
    ...
    mm.openShape("/Users/bsnizek/Projects/Mapmatching/pymapmatching/testdata/Sparse_small.shp")
    
    print "Road network imported"
    
    print "Parsing road network -> graph"
    mm.shapeToGraph("/Users/bsnizek/Projects/Mapmatching/pymapmatching/testdata/Sparse_small.shp", uniqueId="ID_NR")
